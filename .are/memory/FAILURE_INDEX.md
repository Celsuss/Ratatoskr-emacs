...
| [FAIL-0005](failures/FAIL-0005.md) | MEDIUM | verification-gap | git config | `core.hooksPath` unset, so the local pre-commit gate is off | pre-existing | PARTIAL — CI added 2026-08-24; hook still off | `are-audit` check `hooks-installed` (warn) |
